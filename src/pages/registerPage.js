            ...
            <Form>
              <FormGroup>
                <Input
                  ...
                  innerRef={(elemen) => (this.regisUsername = elemen)}
                />
              </FormGroup>
              <FormGroup>
                <Input
                  ...
                  innerRef={(elemen) => (this.regisNama = elemen)}
                />
              </FormGroup>
              <FormGroup>
                <Input
                  ...
                  innerRef={(elemen) => (this.regisEmail = elemen)}
                />
              </FormGroup>
              <FormGroup>
                <Input
                  ...
                  innerRef={(elemen) => (this.regisPassword = elemen)}
                />
              </FormGroup>
              <FormGroup>
                <Input
                  ...
                  innerRef={(elemen) => (this.regisConfirmPassword = elemen)}
                />
              </FormGroup>
              <FormGroup>
                <Input
                  ...
                  innerRef={(elemen) => (this.regisTelp = elemen)}
                />
              </FormGroup>
            </Form>
            <Button
